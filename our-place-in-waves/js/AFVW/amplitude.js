const velocitySlider = document.getElementById('solo-velocity');
const frequencySlider = document.getElementById('solo-frequency');
const wavelengthSlider = document.getElementById('solo-wavelength');
...
const canvas = document.getElementById("amplitude-wave");
...
const soloAmplitudeSlider = document.getElementById('solo-amplitude');
// const amplitudeValueDisplay = document.getElementById('amplitudeValue');

const minOpacity = 0.2;
const maxOpacity = 2;

soloAmplitudeSlider.addEventListener('input', () => {
    amplitude = parseFloat(soloAmplitudeSlider.value);
